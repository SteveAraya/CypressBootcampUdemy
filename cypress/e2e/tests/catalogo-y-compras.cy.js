...
import { ThankYouPopUpMethods } from '../pages/thank-you-popup/thank-you-popup.methods';
...
describe(CommonPageData.testSuites.catalogoYCompras, ()=>{
    ...
    it('Realizar una compra', ()=>{
        ...
        ThankYouPopUpMethods.varifyGreenCheckMarkIsDisplayed();
        ThankYouPopUpMethods.clickOnOkButton();
